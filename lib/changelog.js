...
export const CHANGELOG = [
  {
    version: "1.8",
    date: "June 16, 2026",
    title: "Pick your ride: taxi, trotro, or hover bike",
    items: [
      "Three new cars in driver setup alongside the Street Coupe — a yellow-cornered Ghana Taxi, a tall slogan-board Trotro, and a blue-flamed Hover Bike.",
      "Each one drives differently: the taxi is nimble and planted, the trotro is a heavy bus that's slow to wind up but unstoppable, and the hover bike is the fastest and twitchiest, floating on a cushion of blue flame.",
      "Your paint colour still applies to every car, and your pick sticks for next time.",
    ],
  },
  {
    version: "1.7",
