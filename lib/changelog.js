...
export const CHANGELOG = [
  {
    version: "2.1",
    date: "July 2, 2026",
    title: "Lasers on the Orbital Highway",
    items: [
      "Your car now carries a laser cannon in space. Asteroids sit on the racing line — blast them (F or X on keys, the FIRE button on touch) before you get there, or shatter one on your bumper and lose most of your speed.",
      "The rocks wait in the same places every lap, so learning the field is part of learning the track — and every rival faces the exact same asteroids.",
      "Explosions, laser zaps and shatter sounds included; your finish screen now counts the asteroids you cleared.",
      "Gold on the Orbital Highway is now 2:45.5, recalibrated for the asteroid field.",
    ],
  },
  {
    version: "2.0",
    date: "July 2, 2026",
    title: "Race in space — the Orbital Highway",
    items: [
      "A third circuit: the Orbital Highway, a neon expressway looped around a ringed gas giant. Climb flat-out to a weightless crest, dive through the esses, and thread the station hairpin.",
      "The sky out there is alive — a spiral galaxy, soft nebulas, drifting asteroids, satellites, and a wheel station turning on the horizon.",
      "Glowing light-wall rails and a spinning ring gate mark the route, and the guideway's magnetic assist sharpens steering at top speed, so corrections land the moment you press.",
      "No day or night in orbit — the track races under its own permanent starlight.",
      "New cover art on the landing page starring the space circuit.",
    ],
  },
  {
    version: "1.9",
